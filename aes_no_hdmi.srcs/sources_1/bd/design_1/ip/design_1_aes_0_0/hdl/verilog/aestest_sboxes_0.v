...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module aestest_sboxes_0_rom (
...
initial begin
    $readmemh("./aestest_sboxes_0_rom.dat", ram0);
    $readmemh("./aestest_sboxes_0_rom.dat", ram1);
    $readmemh("./aestest_sboxes_0_rom.dat", ram2);
    $readmemh("./aestest_sboxes_0_rom.dat", ram3);
    $readmemh("./aestest_sboxes_0_rom.dat", ram4);
end
...
aestest_sboxes_0_rom aestest_sboxes_0_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
