...
//------------------------Instantiation------------------
// aes_AXI_DMA_SLAVE_request_preprocessor
aes_AXI_DMA_SLAVE_request_preprocessor #(
...
module aes_AXI_DMA_SLAVE_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
module aes_AXI_DMA_SLAVE_write/*{{{*/
#(parameter
    C_ID_WIDTH        = 1,
    C_ADDR_WIDTH      = 32,
    C_DATA_WIDTH      = 32,
...
//------------------------Instantiation------------------
// aes_AXI_DMA_SLAVE_read_data_align
aes_AXI_DMA_SLAVE_read_data_align #(
    .C_DATA_WIDTH      ( C_DATA_WIDTH ),
    .C_USER_DATA_WIDTH ( C_USER_DATA_WIDTH )
) data_align (
...
module aes_AXI_DMA_SLAVE_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
...
module aes_AXI_DMA_SLAVE_reg_slice/*{{{*/
#(parameter
    N = 8   // data width
) (
    // system signals
